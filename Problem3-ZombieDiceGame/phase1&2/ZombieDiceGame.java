//********************************************************************
//  ZombieDiceGame.java, PHASE ONE & TWO       Template by CS230 Staff S17
//
...
public class ZombieDiceGame {
  ...
  public ZombieDiceGame(String playerName, String computerName){
    ...
    for (int i = 0; i < NUM_DICE; i++) { //add the zombieDie to dice
  ...
  //I'm not sure if scanner is what's supposed to be used here...GUI Maybe???
  //anyways....returns true if player won the game
  ...
  public String currentScore(){
    String s = player + " has consumed "+ player.getBrainsAte() + "of 13 brains";
    s += "\n"+ computer + " has consumed "+ computer.getBrainsAte() + "of 13 brains";
    return s;
  }
